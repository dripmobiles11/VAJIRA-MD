...
global.owner = process.env.OWNER_NUMBER  || '923197477537' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=KQNgwS7Q#tm4bpLrVX-BDlMraZVZO0YExbDf1XVmSZuBFz5gZ72o' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "923197477537" : process.env.MODERATORS ,    
